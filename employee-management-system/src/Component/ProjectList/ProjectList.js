    ...
    return (
        <div className="m-0 bg-slate-200 min-h-screen ">
            <div className="bg-gray-800 text-white flex justify-between px-8 py-4 items-center ">
                ...
                <div>
                    <input placeholder="Search Project" className="rounded-md p-1 border-l-0 rounded-r-none" />
                    ...
                    <button className="bg-white text-black font-semibold p-1 rounded-md mx-2" onClick={handleAllEmployeeList}>All Employee</button>
            ...
            <div className=" flex flex-wrap gap-4 p-4  justify-center">
                {projectdata?.map((singleProject) => (<div className=" bg-gray-800 rounded-md shadow-lg shadow-red-500/50 ... text-center text-white w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-2">
